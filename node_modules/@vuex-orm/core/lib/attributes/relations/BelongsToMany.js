...
var BelongsToMany = /** @class */ (function (_super) {
    ...
    BelongsToMany.prototype.createPivotRecord = function (data, record, related) {
        ...
        related.forEach(function (id) {
            ...
            data[_this.pivot.entity] = tslib_1.__assign({}, data[_this.pivot.entity], (_a = {}, _a[pivotKey] = tslib_1.__assign({}, pivotRecord, (_b = { $id: pivotKey }, _b[_this.foreignPivotKey] = record[_this.parentKey], _b[_this.relatedPivotKey] = id, _b)), _a));
        });
    };
