...
class News extends ActiveRecord implements LinkedModels {
	...
	public static function labels() {
		return [
			...
			self::PASSANGER_NEWS     => ['ru' => 'Новости пассажирам', 'en' => 'News passengers'],
	...
	public static function getConvertedField($fieldName, $data) {
		switch ($fieldName) {
			...
			case DspNews::ATTR_MESSAGE:
				...
				return $data;
				break;
			case DspNews::ATTR_HOT || DspNews::ATTR_VISIBLE:
				if (empty($data)) {
					return false;
				}
	...
	const CATEGORY_LINK = [
		...
		'0000000002' => self::PASSANGER_NEWS,
